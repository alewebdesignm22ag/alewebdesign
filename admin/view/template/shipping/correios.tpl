    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="correios_prazo_adicional" value="<?php echo $correios_adicional; ?>" placeholder="<?php echo $entry_prazo_adicional; ?>" id="input-correios-prazo-adicional" class="form-control" />
            </div>
          </div>  
          <div class="form-group">
