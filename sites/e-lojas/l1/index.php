...
$value = "ControllerModuleAccount" ;
var_export(get_class_methods($value));

/*

$i = $db->query("SELECT *, (SELECT os.name FROM `oc_order_status` os WHERE os.order_status_id = o.order_status_id AND os.language_id = o.language_id) AS order_status FROM `oc_order` o WHERE o.order_id =20");
var_export($i);
*/
